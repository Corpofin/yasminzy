!(function(t) {
    ...
    e["default"] = {
      ...
      data: function() {
        return {
          ...
          context: null,
          chart: null,
          chart_data: { labels: this.labels, datasets: this.datasets },
          options: {
            responsive: !1,
              ...
              yAxes: [
                {
                  ...
                  ticks: { beginAtZero: this.beginzero }
                }
              ]
            }
          }
      ...
      methods: {
          ...
          null == this.target
            ...
            : ((this.canvas = document.getElementById(this.target)),
              (this.context = document
                ...
                .getContext("2d")),
              "undefined" == typeof datasets && (window.datasets = []),
              "undefined" == typeof datasets[this.target] &&
        ...
        checkOverride: function() {
          null != this.datasets &&
            (this.setDatasets(), (this.isDatasetsOverride = !0)),
            null != this.option &&
              (this.setOption(), (this.isOptionOverride = !0));
        },
        ...
        appendChart: function() {
          window.datasets[this.target].push(this.chart_data.datasets[0]),
            ...
            document.getElementById(this.target).getAttribute("count") ==
              this.chart_data.datasets.length && this.renderChart();
        },
        checkSize: function() {
          (null != this.width && null != this.height) ||
            this.isOptionOverride ||
            ((this.options.responsive = !0),
            (this.options.maintainAspectRatio = !0));
        }
      },
      mounted: function() {
    ...
    e["default"] = {
      ...
      data: function() {
        return {
          ...
          options: {
            scale: { reverse: !0, ticks: { beginAtZero: this.beginzero } }
          }
        };
      }
    };
    ...
    e["default"] = {
      ...
      data: function() {
        return {
          ...
          options: {
            scales: { yAxes: [{ stacked: !1 }], xAxes: [{ stacked: !0 }] }
          }
        };
      }
    };
  ...
  function(t, e, r) {
    ...
    e["default"] = {
      mixins: [VueCharts.core["default"]],
      props: {
        beginzero: { type: Boolean, default: !1 },
    ...
    e["default"] = {
      ...
      data: function() {
        return {
          ...
          options: {
            scale: { reverse: !1, ticks: { beginAtZero: this.beginzero } }
          }
        };
      }
    };
  ...
  function(t, e, r) {
    ...
    (window.VueCharts = {}),
      (VueCharts.core = r(0)),
      (VueCharts.install = function(t) {
        t.component("chartjs-line", r(4)),
          t.component("chartjs-bar", r(1)),
          t.component("chartjs-horizontal-bar", r(3)),
          t.component("chartjs-radar", r(7)),
          t.component("chartjs-polar-area", r(6)),
          t.component("chartjs-pie", r(5)),
          t.component("chartjs-doughnut", r(2));
      });
  }
]);
